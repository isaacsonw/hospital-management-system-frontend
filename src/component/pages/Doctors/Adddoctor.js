...
import { Form, Button, Divider,Ref, TextArea,Label} from 'semantic-ui-react';
import {GenderOptions,EmploymentType,Specialty,Experience} from '../../tools/SignupOptions';
...
export default class Adddoctor extends Component {
    ...
    handlePost =()=>{
        ...
        reqwest({
            url:`${ApiUrl}doctors_management/createDoctors`,
            method: 'post',
            data:this.state || {} ,
            type: 'json',
    ...
    render() {
       ...
       return (
           <div className='doctorForm' style={styles.addForm}>
               <Divider  horizontal><Label>Doctor's Information</Label></Divider>
